 ...
 */
@Slf4j
public class P2PMarketStats extends TorBasedMonitorTask {
    ...
    public P2PMarketStats(Properties properties, Reporter graphiteReporter, Map<String, String> seedNodeOperatorByAddress) {
        super(properties, graphiteReporter, seedNodeOperatorByAddress);
    }
