...
import bisq.monitor.tor.TorBasedMonitor;
import bisq.monitor.tor.TorNode;
...
public class MonitorMain {
    ...
    public static void main(String[] args) throws Exception {
        Properties properties = PropertiesUtil.getProperties(args);
        ...
        CompletableFuture.runAsync(() -> {
                    monitor = new Monitor(properties, reporter);
