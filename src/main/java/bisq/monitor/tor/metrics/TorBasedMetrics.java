...
import bisq.monitor.tor.OnionParser;
 ...
 */
@Slf4j
public abstract class TorBasedMetrics extends Metric implements MessageListener {
    ...
    public TorBasedMetrics(Reporter reporter) {
        super(reporter);
    }
                ...
                try {
                    ...
                    Futures.addCallback(future, new FutureCallback<>() {
                        ...
                        public void onSuccess(Connection connection) {
                            connection.addMessageListener(TorBasedMetrics.this);
                        }
