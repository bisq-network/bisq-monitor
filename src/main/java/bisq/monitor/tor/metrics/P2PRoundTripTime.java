...
import bisq.monitor.utils.StatisticsHelper;
...
public class P2PRoundTripTime extends TorBasedMetrics {
    ...
    void report() {
        ...
        {
            Map<String, String> map = StatisticsHelper.process(samples.values());
            String prefix = getName() + "." + OnionParser.prettyPrint(nodeAddress);
            reporter.report(map, prefix);
        }
        ));
